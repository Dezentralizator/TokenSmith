...
function shouldSupportInterfaces (interfaces = []) {
  describe('ERC165', function () {
    ...
    it('supportsInterface uses less than 200k gas', async function () {
      for (const k of interfaces) {
        const interfaceId = INTERFACE_IDS[k];
        expect(await this.contractUnderTest.supportsInterface.estimateGas(interfaceId)).to.be.lte(200000);
        console.log(await this.contractUnderTest.supportsInterface.estimateGas(interfaceId));
      }
    });
