...
const secondTokenId = new BN('7217');
  ...
  context('with minted tokens', function () {
    ...
    describe('transfers', function () {
      ...
      const shouldTransferTokensByUsers = function (transferFunction) {
        ...
        //truffle adds a new error in javascript causing it to fail when the successfull error has been triggered
        xcontext('when the sender is not authorized for the token id', function () {
          it('reverts', async function () {
            await expectRevert(
  ...
  context('with minted tokens', function () {
    ...
    describe('tokenByIndex', function () {
      ...
      [firstTokenId, secondTokenId].forEach(function (tokenId) {
        xit(`returns all tokens after burning token ${tokenId} and minting new tokens`, async function () {
